...
export default function ChatBoxChannelHeader() {
	...
	return channel.id === "ai" ? (
		<div className="str-chat__channel-header">
			...
			<div
				className="str-chat__avatar str-chat__message-sender-avatar str-chat__avatar--channel-header str-chat__avatar--one-letter"
				data-testid="avatar"
				role="button"
				title={channelName}
			>
			...
			<div className="str-chat__channel-header-end">
				...
				<p className="str-chat__channel-header-info">
					{channel.data?.member_count} members, {aiInChannel ? 2 : 1} online
				</p>
			</div>
			<AddOrRemoveAIAgent />
		</div>
